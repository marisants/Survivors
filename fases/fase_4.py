...
class FaseQuatro:
    ...
    def jogar(self,tela):
        ...
        imagem_fundo = pygame.image.load("imagens/fundo_4.png").convert() # add a img de fundo
        ...
        scroll = 0 
        velocidade_scroll = 300 #velocidade inicial da rolagem
        velocidade_maxima = 1500 
        aceleracao = 250 # o quanto a velocidade vai aumentar por segundo 
        ...
        while True:
            ...
            if estado == "jogando":
                ...
                if len(obstaculos) == 0 or list(obstaculos)[-1].rect.right < largura - 140:
                    ...
                    if chance == 1:
                        # nasce avião
                        obstaculos.add(Capelo(largura))
                    else:
                        # nasce ou teresa ou o banco
                        obstaculos.add(Obs_fase4(altura - 150)) 
